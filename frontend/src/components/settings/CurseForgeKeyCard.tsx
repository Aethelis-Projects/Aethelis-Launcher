...
import { Key, Eye, EyeOff, Save, CheckCircle2, AlertCircle } from "lucide-solid";
...
export const CurseForgeKeyCard: Component = () => {
  ...
  onMount(async () => {
    try {
      ...
      if (res && res.settings && res.settings["curseforge_api_key"]) {
        setKey(res.settings["curseforge_api_key"]);
      }
    } catch (_err: unknown) {
        ...
        <div class="space-y-1.5">
          ...
          <div class="relative flex items-center">
            <input
              ...
              placeholder="Вставьте $2a$10... ключ CurseForge"
